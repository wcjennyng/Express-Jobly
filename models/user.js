...
class User {
  ...
  static async get(username) {
    ...
    //list of jobIds user has applied for
    const userJobAppRes = await db.query(`SELECT a.job_id FROM applications a WHERE a.username = $1`, [username])
    user.applications = userJobAppRes.rows.map(a => a.job_id)
    return user;
  }
  ...
  static async applyToJob(username, jobId) {
    ...
    await db.query(`INSERT INTO applications (job_id, username) 
